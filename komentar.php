                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td class="mb-3">
                                ...
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="isikomentar" border="1"></textarea>
                            </td>
        ...
        <div class="table">
            <div class="container-fluid mt-3">
                <div class="d-flex justify-content-center">
                    <table width="100%" border="1" cellpadding=5 cellspacing=0 class="table-bordered table-striped table-secondary">
                        <tr>
                            <th>ID</th>
                            <th>Nama</th>
                            <th>Komentar</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="hapus_komentar.php" method="post">
                                        <button type=submit><img src="icon/trash.png" alt=""></button>
                                    </form>
                                </td>
                            </tr>
                        <?php
