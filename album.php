    ...
    <form action="tambah_album.php" method="post">
        <div class="table table-borderless">
            <table class="d-flex justify-content-center">
                <tr>
                    <td>Nama Album</td>
                    <td><input type="text" name="namaalbum" class="form-control m-1" id="exampleFormControlInput1">
                    </td>
                </tr>
                <tr>
                    <td>Deskripsi</td>
                    <td><input type="text" name="deskripsi" class="form-control m-1" id="exampleFormControlInput1"></td>
                </tr>
